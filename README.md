...
Приложение написанно с использованием Vue, VueX, Vue-Router, Javascript. Так же есть отдельная страница с данными для анализа своей работы. В приложении можно:
